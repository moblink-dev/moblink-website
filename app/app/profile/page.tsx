...
import ProfileImageUpload from "../../../components/app/ProfileImageUpload";
...
export default function ProfilePage() {
  return <main className="app-page"><div className="phone-shell phone-shell-compact account-shell">
    ...
    <section className="account-section"><h2>Private cloud profile</h2><ProfileImageUpload /></section>
    ...
    <section className="account-section"><h2>Account &amp; preferences</h2><div className="account-group">
      <Link className="account-row" href="/app/account"><span><strong>Account access</strong><small>Guest session or authorised test sign-in</small></span><span aria-hidden="true">›</span></Link>
    ...
    <p className="account-footnote">You’re exploring a staged MobLink release. Use fictional details for testing; requests do not automatically contact providers.</p>
